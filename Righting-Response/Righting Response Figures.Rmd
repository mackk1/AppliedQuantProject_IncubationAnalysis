...
plot(mod_sites[[1]],conf.int='none', xlab ='Time (hours)', ylab = 'Righting Probability', lwd=3)
...
```{r,echo=F}
plot(mod_region[[1]],conf.int='none', xlab ='Time (hours)', ylab = 'Righting Probability', col='dodgerblue3', lwd=3)
...
```{r,echo=F}
plot(mod_sex[[1]],conf.int='none', xlab ='Time (hours)', ylab = 'Righting Probability', lwd=3, col='black', lty=3 )
...
```{r,echo=F}
plot(north_sex, col= c('dodgerblue3'), lty=c(1,3), lwd=3, xlab='Time (hours)', ylab = 'Righting Probability')
